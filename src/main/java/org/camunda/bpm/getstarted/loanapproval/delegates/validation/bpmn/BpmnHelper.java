...
public class BpmnHelper {
     ...
     */
    public static BpmnDefinitions parseBpmnFile(String bpmnFilePath) {
        try {
            ...
            return new BpmnDefinitions(id, targetNamespace, collaboration, processes);
     ...
     * @param archimateRoles  the list of roles from archimate data for resolving
     *                        references
     * @return updated BpmnDefinitions with resolved assignees
     */
    public static BpmnDefinitions updateLanesWithAssignees(
            BpmnDefinitions bpmnDefinitions,
            ConfigFile configFile,
            List<Role> archimateRoles) {
     ...
     * their lanes
     */
    public static BpmnDefinitions updateUserTasksWithLaneAssignees(BpmnDefinitions bpmnDefinitions) {
     ...
     * set
     */
    public static BpmnDefinitions updateUserTasksWithFormRefsAndResolvedFormOutputVariableName(
            BpmnDefinitions bpmnDefinitions,
            ConfigFile configFile) {
     ...
     */
    public static BpmnDefinitions updateTasksWithEmailDelegateBeanName(
            BpmnDefinitions bpmnDefinitions,
            ConfigFile configFile) {
     ...
     */
    public static BpmnDefinitions updateTasksWithRestCallDelegateBeanName(
            BpmnDefinitions bpmnDefinitions,
            ConfigFile configFile) {
     ...
     */
    public static BpmnDefinitions updateFlowNodesWithDmnRefAndDmnResultVariable(
            BpmnDefinitions bpmnDefinitions,
            ConfigFile configFile) {
     ...
     */
    public static BpmnDefinitions updateFlowNodesWithVendorAttributes(
            BpmnDefinitions bpmnDefinitions,
            ConfigFile configFile) {
     ...
     */
    public static BpmnDefinitions resolveGlobalVariablesInSequenceFlows(
            BpmnDefinitions bpmnDefinitions,
     ...
     */
    public static BpmnDefinitions convertDotsToUnderscoresInSequenceFlows(
            BpmnDefinitions bpmnDefinitions) {
