...
public class Main {
    ...
    private final String bpmnFilePath = "src/main/resources/models/diagram_1.bpmn";
    private final List<String> formPaths = List.of("models/form/approve_absence_form.json", "models/form/provide_further_explanation_form.json", "models/form/request_absence_form.json");
    private final List<String> restActionPaths = List.of("models/rest/notify_employee_rest.json");
    private final List<String[]> emailConfigsPaths = List.<String[]>of(
            new String[]{"models/email/remind_line_manager_email.ftl", "models/email/remind_line_manager_email.json"});
    ...
    private final String procFilePath = "src/main/resources/models/diagram_1-1.0.proc";
