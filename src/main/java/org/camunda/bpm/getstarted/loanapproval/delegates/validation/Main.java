...
public class Main {
    ...
    private final String bpmnFilePath = "src/main/resources/models/subprocess.bpmn";
    ...
    String procFilePath = "src/main/resources/models/subprocess-1.0.proc";
...
//        camundaGenerateArtifacts();
    ...
    private void bonitaGenerateArtifacts() {
        ...
        BonitaFormGenerator.generateFormsFromConfigAndBpmn(configFileData, bpmnDefinitions, procDocument,
