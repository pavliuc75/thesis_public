...
public class OrganizationDataHelper {
    ...
    public static List<Role> loadFromResources(String resourcePath) throws Exception {
        try (InputStream in = OrganizationDataHelper.class.getClassLoader().getResourceAsStream(resourcePath)) {
            if (in == null) {
    ...
    /** Loads organization data from a classpath resource path; same signature pattern as other helpers (path → data object). */
    public static OrganizationData loadFromFile(String resourcePath) throws Exception {
        OrganizationData data = new OrganizationData();
        data.setArchimateRoles(loadFromResources(resourcePath));
        return data;
    }

    public static void main(String[] args) throws Exception {
        OrganizationDataHelper parser = new OrganizationDataHelper();
