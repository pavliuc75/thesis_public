...
public class CamundaBpmnHelper {
     ...
     */
    public static BpmnData resolveSequenceFlowExpressions(BpmnData bpmnDefinitions) {
     ...
     */
    public static BpmnData resolveBusinessRuleTasks(BpmnData bpmnDefinitions) {
        if (bpmnDefinitions == null || bpmnDefinitions.processes() == null) {
            return bpmnDefinitions;
        }
